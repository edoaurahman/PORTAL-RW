...
class AlamatSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $alamat = [
            ...
            ["id_alamat" => "22", "rw" => 2, "rt" => 5, "kel" => "Kedungkandang", "kecamatan" => "Kedungkandang", "jalan" => "Jl. Anggrek Ungu No. 67"],
            ...
            ["id_alamat" => "32", "rw" => 2, "rt" => 6, "kel" => "Arjosari", "kecamatan" => "Blimbing", "jalan" => "Jl. Mawar Elok No. 10"],
            ...
            ["id_alamat" => "36", "rw" => 2, "rt" => 7, "kel" => "Arjosari", "kecamatan" => "Blimbing", "jalan" => "Jl. Mawar Permai No. 14"],
