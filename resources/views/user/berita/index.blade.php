        ...
        <div class="block md:flex md:space-x-2 px-2 lg:p-0">
            ...
            <a class="mb-4 md:mb-0 w-full md:w-2/3 relative rounded inline-block h-[24em] overflow-hidden"
                ...
                <div class="p-4 absolute bottom-0 left-0 z-20">
                    <span
                        class="px-4 py-1 bg-black text-gray-200 inline-flex items-center justify-center mb-2">{{ $berita_populer[0]->kategori[0]->nama_kategori }}</span>
            ...
            <a class="{{ $berita_populer[1] == null ? 'hidden' : '' }} w-full md:w-1/3 relative rounded" style=height:
                ...
                <div class="p-4 absolute bottom-0 left-0 z-20">
                    <span
                        class="px-4 py-1 bg-black text-gray-200 inline-flex items-center justify-center mb-2">{{ $berita_populer[1]->kategori[0]->nama_kategori }}</span>
                        ...
                        <div class="bg-white rounded px-4 flex flex-col justify-between leading-normal w-full p-5">
                            <div>
                                <div class="mt-3 md:mt-0 ">
                                    <p class="text-gray-700 font-bold text-1xl mb-2">{{ $item->judul }}</p>
                                </div>
