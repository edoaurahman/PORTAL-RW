    ...
    <section class="row max-w-6xl mx-auto font-sans py-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg max-h-70 bg-purple-400 " src="assets/images/illustration/pindahMasuk.png" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-[20px] font-bold tracking-tight text-gray-900 dark:text-white">Pindah
                            Kependudukan</h5>
                    </a>
                    <p class="mb-3  font-normal text-gray-700 dark:text-gray-400">Siapkan: <br> -KTP <br> -KK.</p>
