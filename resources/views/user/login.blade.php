    ...
    <div class="grid grid-cols-2 h-screen">
        <div class="flex justify-center items-center bg-blue-500">
            <div class="text-right pr-20 pl-20">
                <h2 class="text-5xl font-bold font-sans text-chocolate-light mb-5">Membangun Hubungan di Era Digital
                    Portal
                    Web RW 02
                </h2>
                <p class="text-white text-lg mb-9">Selamat datang di Portal Web RW 02, tempat di mana Anda dapat
                    ...
                    kita.</p>
                <button type="button"
                    class="text-chocolate-light hover:text-white border-2 border-chocolate-light hover:bg-chocolate-light focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium text-base px-8 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-yellow-300 dark:hover:text-white dark:hover:bg-yellow-400 dark:focus:ring-yellow-900">
                    Beranda</button>
            </div>
        </div>
        <div class="flex justify-center items-center bg-white">
            <form class="w-full pl-20 pr-24">
                <h1 class="text-3xl font-sans font-medium text-chocolate-light mb-2">Welcome!</h1>
                ...
                <div class="mb-5">
                    ...
                    <input type="email" id="email"
                        class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm  focus:ring-chocolate-light focus:border-chocolate-light block w-full py-3 px-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                ...
                <div class="flex items-center mb-5 mt-4">
                    ...
                    <label for="terms" class="ms-2 text-base font-medium  text-gray-900 dark:text-gray-300">I
                        agree
                        with
                        the <a href="#" class="text-chocolate-light hover:underline dark:text-blue-500">terms and
                            conditions</a></label>
                </div>
                <button type="submit"
                    class="text-white bg-chocolate-light hover:bg-chocolate focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-lg px-5 py-4 w-full text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register
                    new account</button>
            </form>
        </div>
    </div>
