        ...
        <div class="w-full">
            ...
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative overflow-hidden h-52 md:h-[468px]">
                    <div class="w-full absolute z-999 bg-gradient-to-b from-transparent from-70% via-gray-400 via-100%">
                    </div>
                    <!-- Item 1 -->
                    @foreach ($umkm->gambarSlide as $item)
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src="{{ $item->getSlideUMKM() }}" loading="lazy"
                                class="h-full object-cover absolute block -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                alt="...">
                        </div>
                    @endforeach
                </div>
                ...
                <button type="button"
                    ...
                    data-carousel-prev>
                    <span
                        class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-600 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
