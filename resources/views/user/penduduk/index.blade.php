<x-layout.user-layout>
    <div class="dark:bg-[#1f1345]">
        <section class="max-w-6xl mx-auto font-sans pb-12 pt-[100px] sm:px-0 px-10">
            <div class="flex flex-col gap-y-10 sm:flex-row items-center justify-between gap-x-20">
                ...
                <div class="flex flex-row item-center">
                    <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-[#2a045c] p-4 md:p-6">
        ...
        <form action="" method="get" class="w-full mx-auto sm:max-w-6xl sm:px-0 px-10">
            <div
                class="flex items-end justify-between
        flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-10">
        ...
        <section
            class="tablePenduduk max-w-6xl mx-auto font-sans py-5 relative overflow-x-auto  sm:rounded-lg sm:px-0 px-10">
