                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div class="relative mb-6">
                            ...
                            <input required value="{{ old('no_kk') }}" name="no_kk" type="text" list="listKK"
                                id="no-kk"
                        ...
                        <div class="flex items-center mb-4">
                            <input id="default-checkbox" type="checkbox" value="true" value="{{ old('isKepalaKK') }}"
                                name="isKepalaKK"
                        ...
                        <div class="flex">
                            ...
                            <input required value="{{ old('tgl_lahir') }}" name="tgl_lahir" type="date"
                                id="tgl-lahir"
                                class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Malang">
                        </div>
                        ...
                        <label for="status-penduduk"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status
                            Penduduk</label>
                        <select value="{{ old('status_penduduk') }}" name="status_penduduk" id="status-penduduk"
                            required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected disabled value>-- Pilih Status --</option>
                            <option value="Pendatang" {{ old('status_penduduk') == 'Pendatang' ? 'selected' : '' }}>
                                Pendatang</option>
                            <option value="Penduduk Tetap"
                                {{ old('status_penduduk') == 'Penduduk Tetap' ? 'selected' : '' }}>Penduduk Tetap
                            </option>
                        </select>
                        ...
                        <div class="flex">
                            ...
                            <input value="{{ old('kelurahan') }}" name="kelurahan" type="text" id="kelurahan"
                                required
                                class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
