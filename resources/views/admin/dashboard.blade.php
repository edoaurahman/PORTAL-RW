<x-layout.admin-layout>
    ...
    <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <!-- ====== Chart One Start -->
        <div class="col-span-12 rounded-sm border border-gray-200 bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-gray-700 dark:bg-gray-800 sm:px-7.5 xl:col-span-8">
            <div class="flex flex-wrap items-start justify-between gap-4 sm:!flex-nowrap">
              ...
              <div class="flex w-full flex-wrap gap-3 sm:gap-5">
                <div class="flex min-w-47.5">
                  <span class="mr-2 mt-1 flex h-4 w-full max-w-4 items-center justify-center rounded-full border border-blue-500">
                ...
                <div class="flex min-w-47.5">
                  <span class="mr-2 mt-1 flex h-4 w-full max-w-4 items-center justify-center rounded-full border border-pink-500">
        ...
        <!-- ====== Chart Two Start -->
        <div class="col-span-12 rounded-sm border border-gray-200 bg-white py-6 shadow-default dark:border-gray-700 dark:bg-gray-800 xl:col-span-4">
            <h4 class="mb-6 px-7.5 text-xl font-bold text-black dark:text-white text-center">
              Agenda RW
            </h4>
          
            <div>
              <a href="messages.html" class="flex items-center gap-5 px-7.5 py-3 border-b border-gray-300 dark:border-gray-600 hover:bg-gray-3 dark:hover:bg-meta-4">
        ...
        <div class="col-span-12 rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-7">
            ...
            <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              <div class="rounded-sm border border-gray-300 shadow-default dark:border-strokedark dark:bg-boxdark">
                <img class="w-full object-cover rounded-t-sm" src="{{ asset('assets/images/umkm/umkm1.jpeg') }}" alt="UMKM 1">
                <div class="p-4">
                  <h5 class="text-lg font-medium mb-1">Warung Madura Cak Abid</h5>
                </div>
              </div>
              <div class="rounded-sm border border-gray-300 shadow-default dark:border-strokedark dark:bg-boxdark">
                <img class="w-full object-cover rounded-t-sm" src="{{ asset('assets/images/umkm/umkm3.jpeg') }}" alt="UMKM 2">
                <div class="p-4">
                  <h5 class="text-lg font-medium mb-1">Maklor Anang</h5>
                </div>
              </div>
              <div class="rounded-sm border border-gray-300 shadow-default dark:border-strokedark dark:bg-boxdark">
                <img class="w-full object-cover rounded-t-sm" src="{{ asset('assets/images/umkm/umkm2.jpeg') }}" alt="UMKM 3">
                <div class="p-4">
