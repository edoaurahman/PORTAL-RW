                    ...
                    <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
                        ...
                        <div>
                            ...
                            <ul class="mb-6 flex flex-col gap-1.5">
                                ...
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                        href="aspirasi" @click="selected = (selected === 'Profile' ? '':'Profile')"
                                        :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile') }"
                                        :class="page === 'profile' && 'bg-graydark'">
                                ...
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                        href="report_data" @click="selected = (selected === 'Profile' ? '':'Profile')"
                                        :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile') }"
                                        :class="page === 'profile' && 'bg-graydark'">
                                            ...
                                            <li>
                                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                    ...
                                                    <div class="h-12.5 w-12.5 rounded-full">
                                                        <img src="{{ asset('assets/images/user/user-04.png') }}"
                                                            alt="User" />
                                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3 p-2.5 xl:!p-5">
                                                <div class="flex-shrink-0">
                                                    <img src="{{asset('assets/images/brand/brand-01.svg')}}"
                                                        alt="Brand">
                                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3 p-2.5 xl:!p-5">
                                                <div class="flex-shrink-0">
                                                    <img src="{{asset('assets/images/brand/brand-02.svg')}}"
                                                        alt="Brand">
                                                </div>
                                                <p class="hidden font-medium text-black dark:text-white sm:block">
                                                    Twitter
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3 p-2.5 xl:!p-5">
                                                <div class="flex-shrink-0">
                                                    <img src="{{asset('assets/images/brand/brand-03.svg')}}"
                                                        alt="Brand">
                                                </div>
                                                <p class="hidden font-medium text-black dark:text-white sm:block">
                                                    Github
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3 p-2.5 xl:!p-5">
                                                <div class="flex-shrink-0">
                                                    <img src="{{asset('assets/images/brand/brand-04.svg')}}"
                                                        alt="Brand">
                                                </div>
                                                <p class="hidden font-medium text-black dark:text-white sm:block">
                                                    Vimeo
                                        ...
                                        <div class="grid grid-cols-3 sm:!grid-cols-5">
                                            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                                                <div class="flex-shrink-0">
                                                    <img src="{{asset('assets/images/brand/brand-05.svg')}}"
                                                        alt="Brand">
                                                </div>
                                                <p class="hidden font-medium text-black dark:text-white sm:block">
                                                    Facebook
