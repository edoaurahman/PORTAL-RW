...
<body x-data="{ 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, 'levelUser': '{{ auth()->user()->level->nama_level }}' }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
