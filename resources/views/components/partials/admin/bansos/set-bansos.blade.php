...
<div>
    <form id="bansos" action="{{ route('admin.bansos.status') }}" method="post" enctype="multipart/form-data"
        x-data="status">
        @csrf
        @method('put')
        <div id="status-bansos" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div class="flex">
                            ...
                            <input readonly required name="no_kk" type="number" id="no_kk"
                        ...
                        <div class="flex">
                            ...
                            <select @change="toggle($event.target.value)" required value="{{ old('status') }}"
                        ...
                        <div x-show="is === 'rejected'">
                            ...
                            <div class="flex">
                                ...
                                <input value="{{ old('alasan') }}" name="alasan" type="text" id="alasan"
                                    class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="flex items-center p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        <button data-modal-hide="status-bansos" type="button"
...
<script>
    function showStatusForm(e) {
        ...
        form.querySelector('input[name="no_kk"]').value = e.no_kk;
    }
