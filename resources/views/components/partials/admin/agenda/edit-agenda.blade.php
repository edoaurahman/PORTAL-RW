<div id="edit-agenda" x-show="$store.agenda.on"
    ...
    <div class="bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-[80vh] sm:w-full"
        ...
        <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[80vh]">
            <form action="{{ route('admin.agenda.update') }}" method="POST">
                @csrf
                @method('PUT')
                <input type="hidden" name="id" :value="$store.agenda.id">
                ...
                <div class="flex">
                    ...
                    <input :value="$store.agenda.title" required name="title" type="text" id="title"
                ...
                <div class="flex">
                    ...
                    <input :value="$store.agenda.deskripsi" required name="deskripsi" type="text" id="deskripsi"
                        class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Deskripsi">
                </div>

                <label for="start" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mulai</label>
                <div class="flex">
                    <span
                        class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                    ...
                    <input :value="$store.agenda.start" required name="start" type="datetime-local" id="start"
                        class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="NIK">
                </div>
                ...
                <div class="flex">
                    ...
                    <input :value="$store.agenda.end" required name="end" type="datetime-local" id="end"
                        class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="NIK">
                </div>
                <!-- Modal footer -->
                <div class="flex items-center py-2 border-t border-gray-200 rounded-b dark:border-gray-600 gap-x-2">
                    <button type="submit"
                    ...
                    <a :href="'/admin/agenda/delete/' + $store.agenda.id">
                        <button type="button"
