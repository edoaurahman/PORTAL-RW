<div>
    <form action="{{ route('admin.penduduk.akun.update') }}" method="post" id="form-edit-akun">
        @csrf
        @method('PUT')
        <div id="edit-akun-penduduk" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-[80%]">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <p id="filled_error_help" class="mt-2 text-xs text-yellow-300">Kosongkah password jika tidak
                            ingin diubah</p>
                        <label for="email"
