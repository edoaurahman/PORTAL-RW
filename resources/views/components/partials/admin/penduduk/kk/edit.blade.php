...
<div>
    <form action="{{ route('admin.penduduk.kk.update') }}" method="post" id="form-edit-kk">
        @csrf
        @method('PUT')
        <input type="hidden" name="no_kk_prev">
        <div id="edit-kk" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div class="flex">
                            ...
                            <input autocomplete="off" required name="no_kk" type="text" id="no_kk"
                        ...
                        <div class="flex">
                            ...
                            <input autocomplete="off" list="listPenduduk" required name="nik_kepalakeluarga"
                                type="text" id="nik"
                                class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="NO KK">
                        </div>
                        ...
                        <datalist id="listPenduduk">
                            <template x-for="item in $store.penduduk.list">
                                <option x-text="item.nama" :value="item.nik"></option>
                            </template>
                        </datalist>
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        <button data-modal-hide="edit-kk" type="button"
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.store('penduduk', {
            ...
            showEdit(e) {
                this.getListKK(e.no_kk);
                const formEdit = document.getElementById('form-edit-kk');
                ...
                formEdit.no_kk_prev.value = e.no_kk;
            }
        })
    })
</script>
