<form class="sm:w-[50vw] order-1">
    <div class="flex">
        ...
        <div class="relative w-90">
            ...
            <button type="submit"
                class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-blue-700 hover:bg-blue-800 dark:bg-purple-700 dark:hover:bg-purple-800 rounded-e-lg borderfocus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800">
