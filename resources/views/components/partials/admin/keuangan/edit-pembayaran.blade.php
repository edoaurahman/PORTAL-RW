...
<div>
    <form action="{{ route('admin.keuangan.update') }}" method="post">
        @csrf
        @method('PUT')
        <div id="pembayaran-edit" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="pembayaran-edit">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div
                            ...
                            <button data-modal-hide="pembayaran-edit" type="button"
...
<script>
    function showFormPembayaran(e) {
        console.log(e);
        const form = document.getElementById('pembayaran-edit');
        form.querySelector('input[name="jumlah"]').value = e.jumlah;
        form.querySelector('input[name="id"]').value = e.id_keuangan;
    }
</script>
