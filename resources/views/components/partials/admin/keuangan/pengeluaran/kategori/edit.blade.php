...
<div>
    <form id="form-edit-kategori" action="{{ route('admin.keuangan.kategori.update') }}" method="post">
        @csrf
        @method('put')
        <div id="edit-kategori" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div class="flex">
                            ...
                            <input value="{{ old('nama_kategori') }}" required name="nama_kategori" type="text"
                                id="nama_kategori"
                        ...
                        <div class="flex items-center pt-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            ...
                            <button data-modal-hide="edit-kategori" type="button"
