...
<div>
    <form id="kategori" action="{{ route('admin.keuangan.kategori.store') }}" method="post">
        @csrf
        <div id="add-kategori" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div class="flex items-center pt-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            ...
                            <button data-modal-hide="add-kategori" type="button"
