...
<div>
    <form id="pengeluaran" action="{{ route('admin.keuangan.pengeluaran.store') }}" method="post">
        @csrf
        <div id="add-pengeluaran" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="add-pengeluaran">
                    ...
                    <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div
                            ...
                            <button data-modal-hide="add-pengeluaran" type="button"
