                    ...
                    <li>
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium dark:hover:text-ungu text-graydark dark:text-black4 duration-300 ease-in-out hover:text-ungu"
